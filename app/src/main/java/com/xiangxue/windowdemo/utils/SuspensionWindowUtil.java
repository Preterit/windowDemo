...
import com.xiangxue.windowdemo.view.SuspensionView;
...
public class SuspensionWindowUtil {
    ...
    public void showSuspensionView() {
        ...
        screenHtight = wm.getDefaultDisplay().getHeight();

        layoutParams.x += screenWidth;
        layoutParams.y += screenHtight - ScreenSizeUtil.dp2px(mContext,10);
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (endX < screenWidth / 2) {
                        ...
                        direction = RIGHT;
                        endX = screenWidth - suspensionView.width;
                    }
                    if (moveX != startX) {
